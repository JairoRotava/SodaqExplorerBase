...
Sodaq_RN2XX3 LoRaWAN;

// Creates a new Sodaq_RN2483 instance.
Sodaq_RN2XX3::Sodaq_RN2XX3() :
    _loraStream(0),
    _diagStream(0),
...
uint8_t Sodaq_RN2XX3::getVersion(char* versionBuffer, uint8_t size)
{
...
void Sodaq_RN2XX3::fillVersionFromReceivedBuffer()
{
...
bool Sodaq_RN2XX3::init(SerialType& stream, int8_t resetPin)
{
    debugPrintLn("[init]");
...
bool Sodaq_RN2XX3::initOTA(SerialType& stream, const uint8_t devEUI[8], const uint8_t appEUI[8], const uint8_t appKey[16], bool adr, int8_t resetPin)
{
...
bool Sodaq_RN2XX3::initOTA(const uint8_t devEUI[8], const uint8_t appEUI[8], const uint8_t appKey[16], bool adr)
{
...
// Returns true on successful connection.
bool Sodaq_RN2XX3::initABP(SerialType& stream, const uint8_t devAddr[4], const uint8_t appSKey[16], const uint8_t nwkSKey[16], bool adr, int8_t resetPin)
{
...
bool Sodaq_RN2XX3::initABP(const uint8_t devAddr[4], const uint8_t appSKey[16], const uint8_t nwkSKey[16], bool adr)
{
...
uint8_t Sodaq_RN2XX3::send(uint8_t port, const uint8_t* payload, uint8_t size)
{
    debugPrintLn("[send]");
...
// Returns 0 (NoError) when transmission is successful or one of the MacTransmitErrorCodes otherwise.
uint8_t Sodaq_RN2XX3::sendReqAck(uint8_t port, const uint8_t* payload,
...
//uint16_t receive(uint8_t* buffer, uint16_t size, uint16_t* port, uint16_t payloadStartPosition = 0);
uint16_t Sodaq_RN2XX3::receive(uint8_t* buffer, uint16_t size, uint8_t* port,
                               uint16_t payloadStartPosition)
{
    ...
    *port = this->_receivedPayloadPort;
...
uint8_t Sodaq_RN2XX3::getHWEUI(uint8_t* buffer, uint8_t size)
{
...
uint16_t Sodaq_RN2XX3::readLn(char* buffer, uint16_t size, uint16_t start)
{
...
bool Sodaq_RN2XX3::expectString(const char* str, uint16_t timeout)
{
...
bool Sodaq_RN2XX3::expectOK()
{
    return expectString(STR_RESULT_OK);
}

void Sodaq_RN2XX3::hardwareReset()
{
...
size_t Sodaq_RN2XX3::writeByte(uint8_t value)
{
    return this->_loraStream->write(value);
}

size_t Sodaq_RN2XX3::print(const String& buffer)
{
    writeProlog();
    debugPrint(buffer);
...
size_t Sodaq_RN2XX3::print(const char buffer[])
{
    writeProlog();
    debugPrint(buffer);
...
size_t Sodaq_RN2XX3::print(char value)
{
    writeProlog();
    debugPrint(value);
...
size_t Sodaq_RN2XX3::print(unsigned char value, int base)
{
    writeProlog();
...
size_t Sodaq_RN2XX3::print(int value, int base)
{
    writeProlog();
    debugPrint(value, base);
...
size_t Sodaq_RN2XX3::print(unsigned int value, int base)
{
    writeProlog();
    debugPrint(value, base);
...
size_t Sodaq_RN2XX3::print(long value, int base)
{
    writeProlog();
    debugPrint(value, base);
...
size_t Sodaq_RN2XX3::print(unsigned long value, int base)
{
    writeProlog();
    debugPrint(value, base);
...
size_t Sodaq_RN2XX3::println(const __FlashStringHelper* ifsh)
{
    size_t n = print(ifsh);
    n += println();
    return n;
...
size_t Sodaq_RN2XX3::println(const String& s)
{
    size_t n = print(s);
    n += println();
    return n;
...
size_t Sodaq_RN2XX3::println(const char c[])
{
    size_t n = print(c);
    n += println();
    return n;
...
size_t Sodaq_RN2XX3::println(char c)
{
    size_t n = print(c);
    n += println();
    return n;
...
size_t Sodaq_RN2XX3::println(unsigned char b, int base)
{
    size_t i = print(b, base);
    return i + println();
}

size_t Sodaq_RN2XX3::println(int num, int base)
{
    size_t i = print(num, base);
    return i + println();
}

size_t Sodaq_RN2XX3::println(unsigned int num, int base)
{
    size_t i = print(num, base);
    return i + println();
}

size_t Sodaq_RN2XX3::println(long num, int base)
{
    size_t i = print(num, base);
    return i + println();
}

size_t Sodaq_RN2XX3::println(unsigned long num, int base)
{
    size_t i = print(num, base);
    return i + println();
}

size_t Sodaq_RN2XX3::println(double num, int digits)
{
    writeProlog();
...
size_t Sodaq_RN2XX3::println(const Printable& x)
{
    size_t i = print(x);
    return i + println();
}

size_t Sodaq_RN2XX3::println(void)
{
    size_t i = print(CRLF);
    _appendCommand = false;
    return i;
...
bool Sodaq_RN2XX3::setFsbChannels(uint8_t fsb)
{
...
bool Sodaq_RN2XX3::setSpreadingFactor(uint8_t spreadingFactor)
{
...
bool Sodaq_RN2XX3::setPowerIndex(uint8_t powerIndex)
{
...
bool Sodaq_RN2XX3::sendCommand(const char* command, const uint8_t* paramValue, uint16_t size)
{
    print(command);
...
// Returns true on success.
// NOTE: command should include a trailing space if paramValue is set
bool Sodaq_RN2XX3::sendCommand(const char* command, uint8_t paramValue)
{
    print(command);
    print(paramValue);
    println();
...
// Returns true on success.
// NOTE: command should include a trailing space if paramValue is set
bool Sodaq_RN2XX3::sendCommand(const char* command, const char* paramValue)
{
    print(command);
...
// Returns true on success.
bool Sodaq_RN2XX3::joinNetwork(const char* type)
{
...
bool Sodaq_RN2XX3::setMacParam(const char* paramName, const uint8_t* paramValue, uint16_t size)
{
    print(STR_CMD_SET);
    print(paramName);
...
// Returns true on success.
// NOTE: paramName should include a trailing space
bool Sodaq_RN2XX3::setMacParam(const char* paramName, uint8_t paramValue)
{
    print(STR_CMD_SET);
    print(paramName);
    print(paramValue);
...
// Returns true on success.
// NOTE: paramName should include a trailing space
bool Sodaq_RN2XX3::setMacParam(const char* paramName, const char* paramValue)
{
    print(STR_CMD_SET);
    print(paramName);
    print(paramValue);
...
uint8_t Sodaq_RN2XX3::lookupMacTransmitError(const char* error)
{
...
uint8_t Sodaq_RN2XX3::macTransmit(const char* type, uint8_t port, const uint8_t* payload, uint8_t size)
{
...
uint8_t Sodaq_RN2XX3::onMacRX()
{
    ...
    // port
    token = strtok(NULL, " ");
    this->_receivedPayloadPort = atoi(token);
    ...
    if ((this->_receivedPayloadSize > 0) && _receiveCallback) {
        _receiveCallback((const uint8_t*)_receivedPayloadBuffer, this->_receivedPayloadPort, this->_receivedPayloadSize); // TODO fix uint8_t vs char
    }
...
void Sodaq_RN2XX3::runTestSequence(SerialType& loraStream, Stream& debugStream)
{
#ifdef DEBUG
    debugPrint("free ram: ");
