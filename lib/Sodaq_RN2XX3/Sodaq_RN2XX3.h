...
#ifndef SODAQ_RN2XX3_H_
#define SODAQ_RN2XX3_H_
...
// Provides a simple, abstracted interface to Microchip's RN2XX3 LoRaWAN module.
//
...
class Sodaq_RN2XX3
{
  public:
    ...
    // Creates a new Sodaq_RN2XX3 instance.
    Sodaq_RN2XX3();
    ...
    // port returns transmittion port.
    uint16_t receive(uint8_t* buffer, uint16_t size, uint8_t* port = 0, uint16_t payloadStartPosition = 0);
  ...
  private:
    ...
    // The port of the received payload buffer.
    uint8_t _receivedPayloadPort;
...
extern Sodaq_RN2XX3 LoRaWAN;

#endif // SODAQ_RN2XX3_H
